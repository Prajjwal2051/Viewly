...
// ============================================
// Enable trust proxy when behind reverse proxy (Render, Heroku, etc.)
// This allows Express to correctly identify client IP from X-Forwarded-* headers
// Required for rate limiting and CORS in production
...
app.use(
    cors({
        ...
        allowedHeaders: [
            ...
            "X-Request-Id", // Custom header for request tracking/debugging
        ],
    })
)
