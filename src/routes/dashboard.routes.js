 ...
 * Retrieves comprehensive analytics for the current user's channel
 *
 * Returns:
 ...
 * @access Private (current user's stats)
 */
router.route("/stats").get(verifyJWT, getChannelStats)

/**
 * GET CHANNEL STATISTICS ROUTE (by channelId)
 * Retrieves comprehensive analytics for a specific channel
 *
